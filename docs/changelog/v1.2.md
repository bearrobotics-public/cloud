...
#### Mission Commands
- **CreateMissionWorkflow** - Create a mission workflow that mirrors touchscreen presets (e.g., automatic return point selection). Supports Servi workflows (delivery, delivery_patrol, bussing, bussing_patrol, birthday, hosting, hosting_patrol) and Carti workflows (traverse, traverse_patrol)

...
=== "gRPCurl"
    ...
    grpcurl \
      ...
      api-test.bearrobotics.api:443 bearrobotics.api.v1.services.cloud.CloudAPIService.CreateMission
...
=== "gRPCurl"
    ...
    grpcurl \
      ...
      api-test.bearrobotics.api:443 bearrobotics.api.v1.services.cloud.CloudAPIService.UpdateMission
    ```
...
=== "gRPCurl"
    ...
    grpcurl \
      ...
      bearrobotics.api.v1.services.cloud.CloudAPIService.SubscribeMissionStatus
    ```
=== "Protobuf"
    ```proto

...
| `command`    | `Command` *enum* <br />`required` | Command to update the state of an active mission. |
...
| Field | Message Type | Description |
|------|------|-------------|
| `missions` | repeated MissionState | List of all missions assigned to the robot, in order from first to last assigned mission. |
...
| `mission_type` | MissionType | Type of the mission. |
...
|`servi_feedback` | servi.Feedback | Feedback specific to Servi missions. |
|`carti_feedback` | carti.Feedback | Feedback specific to Carti missions. |

##### BaseFeedback

| Field | Message Type | Description |
|------|------|-------------|
| `status` | Status *enum* | Current feedback status of the robot. |
...
| Field (*oneof*) | Message Type | Description |
|------------|-------------| ---|
|`base_type` | BaseType *enum* | Base mission types. |
|`servi_type` | servi.ServiType *enum* | Servi-specific mission types. |
|`carti_type` | carti.CartiType *enum* | Carti-specific mission types. |

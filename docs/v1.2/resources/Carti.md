...
!!! Note "CreateMissionWorkflow"
    ...
    |----------------|--------------|-------------|
    | `traverse` | *repeated* [`Goal`](LocalizationAndNavigation.md#goal-goal-required)<br/>`required` | a list of `Goal` |
    | `traverse_patrol` | *repeated* [`Goal`](LocalizationAndNavigation.md#goal-goal-required)<br/>`required` | a list of `Goal` |

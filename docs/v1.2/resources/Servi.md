...
!!! Note "CreateMissionWorkflow"
    ...
    |----------------|--------------|-------------|
    | `delivery` | *repeated* [`Goal`](LocalizationAndNavigation.md#goal-goal-required)<br/>`required` | a list of `Goal` |
    | `delivery_patrol` | *repeated* [`Goal`](LocalizationAndNavigation.md#goal-goal-required)<br/>`required` | a list of `Goal` |
    | `bussing` | *repeated* [`Goal`](LocalizationAndNavigation.md#goal-goal-required)<br/>`required` | a list of `Goal` |
    | `bussing_patrol` | *repeated* [`Goal`](LocalizationAndNavigation.md#goal-goal-required)<br/>`required` | a list of `Goal` |
    | `birthday` | [`Goal`](LocalizationAndNavigation.md#goal-goal-required)<br/>`required` | Single target goal. |
    | `hosting` | *repeated* [`Goal`](LocalizationAndNavigation.md#goal-goal-required)<br/>`required` | a list of `Goal` |
    | `hosting_patrol` | *repeated* [`Goal`](LocalizationAndNavigation.md#goal-goal-required)<br/>`required` | a list of `Goal` |
...
| Field (*oneof*) | Message Type | Description |
|------------|-------------| ---|
|`base_mission`   |[`BaseMission`](Mission.md#basemission)	| Base missions are applicable to all robot families. <br /> Refer to [Mission](Mission.md) for how to create and send a base mission.|
...
| Field | Message Type | Description |
|------|------|-------------|
|`goal`| [`Goal`](LocalizationAndNavigation.md#goal-goal-required) <br />`required`| Single target goal for navigation. |
...
| Field | Message Type | Description |
|------|------|-------------|
|`goals`| *repeated* [`Goal`](LocalizationAndNavigation.md#goal-goal-required) <br />`required`| List of potential goals to choose from. |
...
|`goal`| [`Goal`](LocalizationAndNavigation.md#goal-goal-required) | Target goal for this tray. |

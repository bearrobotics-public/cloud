...
| `md5_checksum` | `string` | MD5 checksum represented as a 32-character lowercase hexadecimal string. Use this to verify the integrity of the downloaded map image. |
